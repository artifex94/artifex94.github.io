...
import { motion, useMotionValue, useTransform, useVelocity, useReducedMotion, animate } from 'framer-motion';
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex-1 bg-accent text-on-accent text-sm font-bold py-2.5 text-center hover:bg-white transition-colors duration-200"
            onClick={onClose}
          >
            Abrir diploma ↗
          </a>
...
export function PlatziCarousel() {
  ...
  const startAutoScroll = useCallback(() => {
    if (reduce || isHovered.current) return;
